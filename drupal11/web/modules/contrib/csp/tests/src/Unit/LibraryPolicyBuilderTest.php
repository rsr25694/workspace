...
class LibraryPolicyBuilderTest extends UnitTestCase {
  ...
  public function testEmptyPolicy(): void {
    ...
    $libraryPolicy->setLogger($this->logger);
   ...
   */
  public function testLibraryWithSources(): void {
   ...
   * @covers ::getLibrarySources
   */
  public function testLibraryWithEmptyStringSource(): void {
   ...
   * @covers ::getLibrarySources
   */
  public function testLibraryWithLocalRouteExternal(): void {
   ...
   * @covers ::getExtensionSources
   */
  public function testInvalidLibraryDefinition(): void {
    $this->moduleHandler->expects($this->any())
      ->method('getModuleList')
      ->willReturn([]);
    $this->themeHandler->expects($this->any())
