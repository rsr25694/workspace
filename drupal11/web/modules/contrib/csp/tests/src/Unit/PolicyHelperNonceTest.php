...
class PolicyHelperNonceTest extends PolicyHelperTestBase {
   ...
   *
   * @return array<string, array{array<string, string[]>, string[], array<string, string[]|bool>}>
   ...
   * @param array<'script'|'style'> $appendTo
  ...
  public static function nonceValidationProvider(): array {
    return [
      ...
      // Unquoted is accepted, though not recommended.
      'unquoted' => [
      ...
      'short value' => ["'nonce-abcdefghijklmnop'", FALSE],
      'valid base64' => [
