...
class CoreCspSubscriberTest extends UnitTestCase {
   ...
   * @covers ::onCspPolicyAlter
   */
  public function testAjaxLibrary(): void {
    $policy = new Csp();
   ...
   * @covers ::onCspPolicyAlter
   */
  public function testCkeditorScriptNoDirectives(): void {
    $policy = new Csp();
   ...
   * @covers ::onCspPolicyAlter
   */
  public function testCkeditorStyle(): void {
    $policy = new Csp();
    $policy->setDirective('default-src', [Csp::POLICY_ANY]);
    $policy->setDirective('style-src', [Csp::POLICY_SELF]);
   ...
   * @covers ::onCspPolicyAlter
   */
  public function testCkeditorStyleFallback(): void {
    $policy = new Csp();
    $policy->setDirective('default-src', [Csp::POLICY_ANY]);
    $policy->setDirective('style-src', [Csp::POLICY_SELF]);
   ...
   * @covers ::onCspPolicyAlter
   */
  public function testCkeditorStyleDefaultFallback(): void {
    $policy = new Csp();
