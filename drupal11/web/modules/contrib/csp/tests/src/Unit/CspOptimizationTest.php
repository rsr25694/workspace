...
class CspOptimizationTest extends UnitTestCase {
   ...
   */
  public function testDefaultSrcFallback(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceSourceList
   */
  public function testWorkerSrcFallback(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceSourceList
   */
  public function testScriptSrcFallback(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceSourceList
   */
  public function testStyleSrcFallback(): void {
    $policy = new Csp();
  ...
  /**
   * Data provider for testing handling of 'none'.
   *
  ...
  public static function noneProvider(): array {
    return [
      ...
      'none and source' => [
        ...
        "script-src example.com 'sha256-123abc'",
      ],
      'nonce, source, report-sample' => [
        [
          Csp::POLICY_NONE,
          Csp::POLICY_REPORT_SAMPLE,
          'example.com',
        ...
        "script-src 'report-sample' example.com 'sha256-123abc'",
      ],
    ];
  }
   ...
   * @covers ::reduceSourceList
   */
  public function testNone(array $sources, string $expected): void {
    $policy = new Csp();
    $policy->setDirective('script-src', $sources);
    $this->assertEquals($expected, $policy->getHeaderValue());
  }
   ...
   * @covers ::reduceSourceList
   */
  public function testReduceSourceListAny(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceSourceList
   */
  public function testReduceSourceListWithHttp(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceSourceList
   */
  public function testReduceSourceListWithHttps(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceSourceList
   */
  public function testReduceSourceListWithWs(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceSourceList
   */
  public function testReduceSourceListWithWss(): void {
    $policy = new Csp();
   ...
   */
  public function testReduceAttrSourceListNetworkSource(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceAttrSourceList
   */
  public function testReduceAttrSourceListWildcard(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceAttrSourceList
   */
  public function testReduceAttrSourceListNoUnsafeHash(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceAttrSourceList
   */
  public function testReduceAttrSourceListUnsafeHash(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceAttrSourceList
   */
  public function testReduceAttrSourceListNonce(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceAttrSourceList
   */
  public function testReduceAttrSourceListOriginallyEmpty(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceAttrSourceList
   */
  public function testReduceAttrSourceListEmpty(): void {
    $policy = new Csp();
   ...
   * @covers ::reduceAttrSourceList
   */
  public function testReduceAttrSourceListFallback(): void {
    $policy = new Csp();
