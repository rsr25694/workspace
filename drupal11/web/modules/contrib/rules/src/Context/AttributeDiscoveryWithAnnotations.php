 ...
 *
 * This is a copy of the core class, overridden to provide Rules-specific
 * discovery by Annotation. The Rules-specific code is needed because of
 * the way core Annotation discovery resolves the ContextDefinition class name -
 * that way does not allow Rules to use its own ContextDefinition class.
 * This problem does not exist with core Attribute discovery.
 *
 * @todo Remove this class when Annotation-based discovery of Rules plugins is
 * no longer supported.
 *
 * @see \Drupal\Core\Plugin\Discovery\AttributeDiscoveryWithAnnotations
 */
