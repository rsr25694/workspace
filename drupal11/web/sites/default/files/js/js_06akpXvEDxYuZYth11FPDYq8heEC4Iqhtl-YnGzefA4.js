...
(function($){'use strict';Drupal.behaviors.captchaAdmin={attach:function(context){var noise_level_shower=function(speed){speed=(typeof speed=='undefined')?'slow':speed;if($('#edit-image-captcha-dot-noise').is(':checked')||$('#edit-image-captcha-line-noise').is(':checked'))$('.form-item-image-captcha-noise-level').show(speed);else $('.form-item-image-captcha-noise-level').hide(speed);};$('#edit-image-captcha-dot-noise').click(noise_level_shower);$('#edit-image-captcha-line-noise').click(noise_level_shower);noise_level_shower(0);var smooth_distortion_shower=function(speed){speed=(typeof speed=='undefined')?'slow':speed;if($('#edit-image-captcha-distortion-amplitude').val()>0)$('.form-item-image-captcha-bilinear-interpolation').show(speed);else $('.form-item-image-captcha-bilinear-interpolation').hide(speed);};$('#edit-image-captcha-distortion-amplitude').change(smooth_distortion_shower);smooth_distortion_shower(0);}};})(jQuery);;
