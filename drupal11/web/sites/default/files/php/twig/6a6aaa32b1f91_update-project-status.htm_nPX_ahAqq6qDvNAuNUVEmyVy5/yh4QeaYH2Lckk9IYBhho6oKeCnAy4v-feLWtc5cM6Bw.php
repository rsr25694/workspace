...
class __TwigTemplate_14528472a53354d75446055139f7b0ba extends Template
{
...
($context["project"] ?? null), "status", [], "any", false, false, true, 36) == Twig\Extension\CoreExtension::constant("Drupal\\update\\UpdateManagerInterface::CURRENT"))) ? ("project-update__status--current gin-status gin-status--success") : (""))];
  ...
  <span class=\"gin-status-icon\">
    ";
        // line 41
        yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "icon", [], "any", false, false, true, 41), "html", null, true);
        yield "
  </span>";
        // line 43
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "label", [], "any", false, false, true, 43)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 44
            yield "<span>";
            yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "label", [], "any", false, false, true, 44), "html", null, true);
            yield "</span>";
        } else {
            // line 46
            yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "reason", [], "any", false, false, true, 46), "html", null, true);
        }
        // line 48
        yield "</div>
...
";
    ...
    {
        return array (  201 => 106,  198 => 105,  196 => 103,  194 => 102,  189 => 99,  187 => 97,  185 => 96,  183 => 95,  179 => 93,  177 => 91,  176 => 90,  169 => 87,  166 => 86,  163 => 85,  159 => 83,  147 => 80,  142 => 79,  138 => 78,  135 => 77,  133 => 76,  130 => 75,  128 => 72,  127 => 71,  126 => 70,  125 => 69,  122 => 67,  111 => 64,  106 => 63,  104 => 62,  100 => 60,  94 => 58,  92 => 57,  87 => 56,  84 => 54,  77 => 52,  75 => 51,  71 => 48,  68 => 46,  63 => 44,  61 => 43,  57 => 41,  51 => 39,  49 => 36,  48 => 35,  47 => 34,  46 => 33,  45 => 32,  44 => 31,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/contrib/gin/templates/admin/update-project-status.html.twig", "/Users/rahulsureshraskar/Workspace/drupal11/web/themes/contrib/gin/templates/admin/update-project-status.html.twig");
    }
